...
$(document).ready(function() {
    ...
    $(document).on("click", ".notes", handleArticleNotes); //check
    $(document).on("click", ".save", handleNoteSave); 
    $(document).on("click", ".ndelete", handleNoteDelete);
      ...
      if (!data.notes.length) {
        ...
        for (var i = 0; i < data.notes.length; i++) {
          ...
          currentNote = $("<li class='list-group-item note'>")
            ...
            .append($("<button class='btn btn-danger ndelete'>x</button>"));
    ...
    function handleNoteSave() {
      ...
      if (newNote) {
        noteData = { headlineId: $(this).data("article")._id, noteText: newNote };
